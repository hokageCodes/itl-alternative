...
const Volunteer = () => {
  // Reusing the same state structure and submission logic
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    console.log("Volunteer Form Submission:", { name, email, phoneNumber, finalLocation });
    // Submission logic for the volunteer form
  };

  return (
    <>
      <div className="min-h-screen flex justify-center items-center bg-bg px-4 pt-16 md:pt-0">
        {/* Adjusted Text Content for Volunteering */}
